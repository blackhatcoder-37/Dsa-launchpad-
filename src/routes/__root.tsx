    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center hand-card p-10">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-xl border border-border bg-background px-4 py-2 text-sm hover:bg-secondary">
            Home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A warm, hand-drawn 25-day journey through Data Structures & Algorithms in Python — for beginners who love a friendly path." },
